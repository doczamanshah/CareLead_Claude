...
export default function SettingsScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        {/* Household & Caregivers Section */}
        <View style={styles.section}>
          <Text style={styles.sectionLabel}>Household & Caregivers</Text>
          ...
          >
            <View style={styles.autoLockContent}>
              <Text style={styles.autoLockLabel}>Manage Household</Text>
              <Text style={styles.autoLockValue}>
                Family members, caregivers, and access
              </Text>
            </View>
          ...
          <View style={styles.pinWrap}>
            ...
            >
              <View style={styles.autoLockContent}>
                <Text style={styles.autoLockLabel}>Invite a caregiver</Text>
                <Text style={styles.autoLockValue}>
                  Share access via email or phone
                </Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={COLORS.text.tertiary} />
            </TouchableOpacity>
          ...
          <View style={styles.pinWrap}>
            ...
            >
              <View style={styles.autoLockContent}>
                <Text style={styles.autoLockLabel}>Enter an invite code</Text>
                <Text style={styles.autoLockValue}>
                  Accept access to a profile
                </Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={COLORS.text.tertiary} />
            </TouchableOpacity>
