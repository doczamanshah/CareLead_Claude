      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.shortcutBody}>
            <Text style={styles.shortcutTitle}>Just one medication? Snap it here.</Text>
        ...
        >
          ...
          <View style={styles.shortcutBody}>
            <Text style={styles.shortcutTitle}>Have a health summary file? Import it.</Text>
            <Text style={styles.shortcutDetail}>
        ...
        <Text style={[styles.sectionLabel, { marginTop: 20 }]}>What are you capturing?</Text>
